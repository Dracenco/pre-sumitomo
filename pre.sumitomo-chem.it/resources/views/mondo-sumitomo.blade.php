          ...
          <div class="teaser-carousel">
            <div class="item light-color">
              <div class="item-image">
                <img src="{{ asset('images/news03.jpg') }}" alt="News Sumitomo">
              </div>
              <div class="item-content">
                <h1 class="item-title">NEWS SUMITOMO CHEMICAL ITALIA</h1>
            ...
            <div class="small-12 columns">
              <nav aria-label="You are here:" role="navigation">
                <ul class="breadcrumbs">
                  ...
                  <li>News SUMITOMO CHEMICAL ITALIA</li>
                </ul>
              </nav>
              <h2 class="page-title">News SUMITOMO CHEMICAL ITALIA</h2>
            </div>
          </div>
    </header>
