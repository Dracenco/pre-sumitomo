...
@section('title', 'Progetti CSR - Sumitomo Chemical Italia')
    ...
    <div class="teaser-carousel">
        <div class="item light-color">
            <div class="item-image">
                <img src="{{ asset('images/slider-2400x800px-07-sicurezza.jpg') }}" alt="Corporate social responsability">
            </div>
   ...
   <header class="page-title_wrap light">
    <div class="row">
        <div class="small-12 columns">
            ...
            <h2 class="page-title">PROGETTI CSR</h2>
        </div>
    </div>
   </header>
