...
@section('title', 'Rete vendita Siapa - Sumitomo Chemical Italia')
    ...
    <div class="teaser-carousel">
        <div class="item light-color">
            <div class="item-image">
                <img src="{{ asset('images/sum_webIST_2400x640_rv_siapa.jpg') }}" alt="Rete vendita Siapa">
            </div>
            <div class="item-content">
                <h1 class="item-title">rete vendita</h1>
                <p class="item-text">I nostri professionisti al servizio dei consorzi agrari</p>
            </div>
        </div>
    </div>
</section>
...
@section('content')
        ...
        <section class="sales-network_wrap">
          <div class="sales-network">
            <a href="<?php echo url('rete-vendita-sumitomo'); ?>" class="sumitomo-logo">
              <img src="{{ asset('images/sumitomo.svg') }}" alt="">
            </a>
            <a href="<?php echo url('rete-vendita-siapa'); ?>" class="active siapa-logo">
        ...
        <!-- siapa network -->
        <section class="boxes_wrap network siapa">
