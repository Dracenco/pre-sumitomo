                  ...
                  <form class="testoPrivacy" method="post">
                      <div class="row">
                          <div class="large-12 columns">
                              <label>Testo Cookie</label><br><textarea name="cookie" id="textareaSito"></textarea>
                          </div>
                      </div>
                      <div class="large-12 columns">
...
<script type="text/javascript">
    ...
    $("form.testoPrivacy").submit(function(e) {
        ...
        post_data='{ "ID" : 8 , "Name" :  "Testo Cookies" , "Description": "' + Description + '", "Visibile" : true , "IdPagina" : 7 }';
        $.ajax({
            type: "POST",
            beforeSend: function (request) {
                request.setRequestHeader("Authorization", "Bearer " + token );
