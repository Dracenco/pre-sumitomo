...
@section('title', 'Rete vendita - Nuova zona')
...
@include('layout.menu-sito')
      ...
      <section id="content-elenco-codici" data-equalizer-watch>
            ...
            <div class="medium-12 large-12 columns">
                <nav aria-label="You are here:" role="navigation">
                    <ul class="breadcrumbs">
                        ...
                        <li class="disabled">Rete vendita - Nuova zona</li>
                    </ul>
                </nav>
            </div>
        </div>
        ...
        <div class="expanded row">
            <div class="large-12 columns"><div class="titolo_sezione"><h2>Nuova zona</h2></div></div>
        </div>
        <div class="expanded row">
            <div class="medium-12 large-12 columns">
               <div class="scheda-nuovo-prodotto">
                 <form class="nuovaZona" method="post">
                     <div class="row">
                     ...
                     <div class="row"><div class="large-12 columns"><label>Riga 1</label></div> </div>
                     <div class="row">
                         <div class="large-6 columns">
                            <label>Regione</label><input type="text" name="regione1" id="regione1">
                         </div>
                         <div class="large-6 columns">
                            <label>Province</label><input type="text" name="province1" id="province1">
                         </div>                         
                     </div>

                     <div class="row"><div class="large-12 columns"><label>Riga 2</label></div> </div>
                     <div class="row">
                         <div class="large-6 columns">
                            <label>Regione</label><input type="text" name="regione2" id="regione2">
                         </div>
                         <div class="large-6 columns">
                            <label>Province</label><input type="text" name="province2" id="province2">
                         </div>                         
                     </div>

                     <div class="row"><div class="large-12 columns"><label>Riga 3</label></div> </div>
                     <div class="row">
                         <div class="large-6 columns">
                            <label>Regione</label><input type="text" name="regione3" id="regione3">
                         </div>
                         <div class="large-6 columns">
                            <label>Province</label><input type="text" name="province3" id="province3">
                         </div>                         
                     </div>

                     <div class="row"><div class="large-12 columns"><label>Riga 4</label></div> </div>
                     <div class="row">
                         <div class="large-6 columns">
                            <label>Regione</label><input type="text" name="regione4" id="regione4">
                         </div>
                         <div class="large-6 columns">
                            <label>Province</label><input type="text" name="province4" id="province4">
                         </div>                         
                     </div>

                     <div class="row"><div class="large-12 columns"><label>Riga 5</label></div> </div>
                     <div class="row">
                         <div class="large-6 columns">
                            <label>Regione</label><input type="text" name="regione5" id="regione5">
                         </div>
                         <div class="large-6 columns">
                            <label>Province</label><input type="text" name="province5" id="province5">
                         </div>                         
                     </div>
...
<script type="text/javascript">
    ...
    $(document).on('submit', '.nuovaZona', function(e) {
        e.preventDefault();
        ...
        post_data='{ "idArea" : "' + idArea + '", "idManagerZona" : "' + capo_areaId + '", "Description" : "' + descrizioneZona + '"}';
            ...
            $.ajax({
                ...
                url: "{{ config('constants.UrlWebService') }}api/Site/CreateZona",
                contentType: true,
                processData: false,
                async:false,
                data: post_data,
