...
@section('title', 'Notizie mondo agricoltura')
...
@include('layout.menu-sito')
      ...
      <section id="content-elenco-codici" data-equalizer-watch>
            ...
            <div class="medium-12 large-12 columns">
                <nav aria-label="You are here:" role="navigation">
                    <ul class="breadcrumbs">
                        ...
                        <li class="disabled">Notizie mondo agricoltura</li>
                    </ul>
                </nav>
            </div>
        </div>
        ...
        <!---->
        <div class="expanded row">
            <div class="large-3 columns"><div class="titolo_sezione"><h2>Notizie mondo agricoltura</h2></div></div>
    ...
    $.ajax({
        ...
        success: function (resultsSection){
            $.each(resultsSection.data, function(index, value){
              ...
              Notizia = Notizia + '<tr><td style="width: 100px;float: left;"><div class="modifica-coltura"><a href="{!! url("sito/modifica-notizia/' + value.id + '") !!}" style="margin-left:0;"><img src="{{ URL::asset('img/matita_nera.png') }}" class="matita"></a></div><div class="elimina-codice"><button class="button" type="button" data-toggle="elimina-codice' + value.id + '" style="margin: 7px 0 0 10px;"><img src="{{ URL::asset('img/cestino_nero.png') }}"></button><div class="dropdown-pane float-right" id="elimina-codice' + value.id + '" data-dropdown><div class="row"><div class="large-12 columns">Confermi l\'eliminazione?</div></div><div class="row"><div class="large-12 columns"><form class="cancella-notizia"><input type="hidden" name="id" value="' + value.id + '"><input type="submit" name="OK" value="OK" ></form></div></div></div></div></td><td style="float: left;padding: 16px 0 0 0;">' + titolo + '</td><td>';                                         
            });              
